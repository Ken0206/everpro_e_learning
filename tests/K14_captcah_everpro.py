...
from webdriver_manager.chrome import ChromeDriverManager    # webdriver-manager 自動安裝,自動更新
...
def e_learning():
    ...
    while True:
        ...
        try:  # 等待搜尋的元素出現才繼續下一步
            ...
            try:  # 等待搜尋的元素出現才繼續下一步
                # 定義物件 “next_btn”
                next_btn = driver.find_element(By.XPATH, '/html/body/div[2]/div/div[1]/div[3]/div[1]/button[7]')
                if next_btn.is_displayed():  # 找到 "next_btn"
                    ...
                    ans_btn = driver.find_element(By.XPATH, '/html/body/div[2]/div/div[1]/div[3]/div[1]/button[1]')
                    if ans_btn.is_displayed():  # 找到 "ans_btn"
                        ans_btn.click()
...
def authentication(insuranceNo):
    try:
        sleep(3)
...
password = 'Aa6666666'
verify = 'u8080'
insuranceNo1 = '0079202419'
insuranceNo2 = 'N15J340507'
insuranceNo = ''
